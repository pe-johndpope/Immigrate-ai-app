...
interface AuthContextI {
  ...
  onSignInWithEmailAndPassword: (email: string, password: string) => Promise<void>,
  onSignInWithGoogle: () => void,
  onSignOut: () => void,
  onSubmitSignUpUserData: (signUpData: any) => void,
  onSignUpWithEmailAndPassword: (email: string, password: string) => Promise<void>,
...
const AuthContextProvider: React.FC = ({
  ...
  const onSignInWithEmailAndPassword = async (email: string, password: string) : Promise<void> => {
    try {
  ...
  const onSignUpWithEmailAndPassword = async (email: string, password: string) : Promise<void> => {
    // create user
