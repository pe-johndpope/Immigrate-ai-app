  ...
  const card = (
    ...
    >
      <Text style={styles.text2}>
        {
          "Question 4: What does “adequate knowledge” of English or French mean when applying for citizenship?"
        }
      </Text>
    </View>
  );
