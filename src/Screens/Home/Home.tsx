...
import { View, Text, Switch, Image, StatusBar, StyleSheet, Dimensions,SafeAreaView, Platform} from "react-native";
...
const Home = () => {
  ...
  const defSubHeading =<Text style = {styles.subHeading1}>Daily Definitions</Text>
  const moveSubHeading =<Text style = {styles.subHeading1}>Lets find your new home!</Text>
  const helpSubHeading =<Text style = {styles.subHeading2}>Need further Assistance?</Text>
  ...
  return (
    <View style={[styles.containerMain, {
      ...
      <View style={{ flex: 2, flexDirection: "row", flexWrap: "wrap", width: "120%"}} >
